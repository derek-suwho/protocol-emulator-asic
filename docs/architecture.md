...
one word to mask the sampled byte with AND-immediate or XOR-transform it before
transmission. Runtime UART firmware can also keep independently selected
background pins enabled during the frame.
