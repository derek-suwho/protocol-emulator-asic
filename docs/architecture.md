...
| `7` | `ALU fn,imm8` | `[11:8]`, `[7:0]` | Transform accumulator; function `0` is AND-immediate, function `1` is OR-immediate, function `2` is XOR-immediate, and functions `4`/`5` are logical shift-left/right by `[2:0]` |
