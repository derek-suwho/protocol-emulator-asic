...
be pulsed before all eight host-input bits carry data. Runtime UART firmware can
also keep independently selected background pins enabled during the frame.
